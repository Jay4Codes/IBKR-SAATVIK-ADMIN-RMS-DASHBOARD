...
function PayoffChart({ points, currency, light, desk }: { points: Points; currency: string; light: boolean; desk: boolean }) {
  return <Chart
    ...
    deps={[points, currency, light, desk]}
    option={(t, zoom) => ({
      animation: false,
